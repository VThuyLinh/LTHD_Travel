...
import MyComponent from "../Alert/Annouce";
...
const BookTour =({route})=>{
    ...
    <View>
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
            {fields.map(f => <TextInput value={f.value} defaultValue={f.default} onChangeText={t=> updateState(f.name,t) } key={f.name} style={MyStyle.margin} label={f.label} secureTextEntry={f.secureTextEntry} keyboardType={f.keyboardType} right={<TextInput.Icon icon={f.icon} />} />)}
            ...
            <Button style={MyStyle.margin}  loading={loading} icon="bag-personal" mode="contained"  
